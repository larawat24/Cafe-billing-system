...
lblLargefries = Label(f1, font=( 'aria' ,16, 'bold' ),text="Sandwich",fg="blue",bd=10,anchor='w')
...
lblCheese_burger = Label(f1, font=( 'aria' ,16, 'bold' ),text="Cake slice",fg="blue",bd=10,anchor='w')
...
#--------------------------------------------------------------------------------------
lblDrinks = Label(f1, font=( 'aria' ,16, 'bold' ),text="Coffee",fg="blue",bd=10,anchor='w')
...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Cake Slice", fg="steel blue", anchor=W)
